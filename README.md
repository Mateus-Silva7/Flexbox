...
- Organização de commits seguindo padrão semelhante ao Conventional Commits
- Estruturação de layout utilizando Flexbox
- Separação de responsabilidades em arquivos CSS
- Boas práticas de reset e estilos globais
